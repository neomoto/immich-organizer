...
The current prerelease is `0.1.0-alpha.4`. Synthetic checks cover the integrated workflow.
Live GLM quality and the alpha4 rollout remain pending. See the setup guide for analysis limits,
