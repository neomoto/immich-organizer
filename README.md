...
The current prerelease is `0.1.0-alpha.3`. Synthetic checks cover the integrated workflow.
Live GLM quality and the alpha3 rollout remain pending. See the setup guide for analysis limits,
